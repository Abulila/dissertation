...
Such a system resembles BPFS (discussed later in Section~\fixme{1} and Section~\fixme{2}) where each persist occurs in its own epoch \cite{ConditNightingale09}.
