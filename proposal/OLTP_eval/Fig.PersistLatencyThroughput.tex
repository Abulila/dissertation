\begin{figure*}
  ...
  %\end{subfigure}
  \subfigure[TATP -- Update Location]{\label{fig::PersistLatencyThroughput::TATP} \includegraphics[width=.45\textwidth]{OLTP_eval/PersistLatencyThroughput_TATP.pdf}}
  ...
  \subfigure[TPCC -- New Order]{\label{fig::PersistLatencyThroughput::TPCC}\includegraphics[width=.45\textwidth]{OLTP_eval/PersistLatencyThroughput_TPCC.pdf}}
