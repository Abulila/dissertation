...
The persist bandwidth analysis study (presented later in Section~\fixme{number}) shows that 35ns per cache line (approximately 1.7GB/s persists) represents sufficient bandwidth to negligibly limit performance.
