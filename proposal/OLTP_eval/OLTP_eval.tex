...
While the behavior is specific to each workload, our results represent trends applicable to most databases and workloads, specifically, index accesses and append-heavy tables.
