...
Our failure model---the recovery observer---requires that stores to each address occur in a serializable order (stores may only observed in a single order at each processor).
