...
While applications do not rely on disk's durability for recovery (in fact, instances that reasonably fit in main memory have no need for disk), modern analytics data sets may reach \fixme{how large and cite} scale, and accessing such large data quickly becomes the dominant bottleneck.
