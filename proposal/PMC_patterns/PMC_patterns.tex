...
\textbf{PEO.} The bottom of Figure~\fixme{ref} displays buffer execution for PEO -- partial epoch order.
...
I introduce an additional optimization to the relaxed consistency model, leveraging \fixme{cite IBM}'s insight that not all values must persist.
