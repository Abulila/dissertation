...
Consider the log in Chapters~\fixme{ref} and~\fixme{ref}, demonstrated in \texttt{persist\_wal} (\fixme{refer back}) and shown here in Figure~\fixme{ref}.
...
Finally, certain data structures may specifically intend to allow races within epochs.
